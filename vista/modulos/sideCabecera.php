<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Willams Abad</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo SERVERURL ?>gallery/" class="nav-link active">
              ...
              <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo SERVERURL ?>calendar/" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Calendar</p>
                </a>
              </li>
              <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo SERVERURL ?>kanban/" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Canvas</p>
                </a>
              </li>
